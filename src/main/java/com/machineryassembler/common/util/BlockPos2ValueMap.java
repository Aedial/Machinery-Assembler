...
// Based on github/kasuminova/mmce/common/util/BlockPos2ValueMap.java from MMCE
...
/**
 * A Map implementation that uses BlockPos as keys but stores them as longs internally
 * for better memory efficiency. Based on StellarCore implementation.
 */
public class BlockPos2ValueMap<V> implements Map<BlockPos, V> {
    ...
    public boolean containsKey(final Object key) {
        if (key instanceof BlockPos) return internal.containsKey(((BlockPos) key).toLong());
    ...
    public V get(final Object key) {
        if (key instanceof BlockPos) return internal.get(((BlockPos) key).toLong());
    ...
    public V remove(final Object key) {
        if (key instanceof BlockPos) return internal.remove(((BlockPos) key).toLong());
    ...
    public boolean equals(final Object o) {
        if (o instanceof BlockPos2ValueMap<?>) return internal.equals(((BlockPos2ValueMap<?>) o).internal);
